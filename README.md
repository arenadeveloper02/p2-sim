...
<p align="center">
<<<<<<< HEAD
  <strong>Arena Agents</strong> is a lightweight, user-friendly platform for building AI agent workflows.
=======
...
<p align="center">
  <img src="apps/sim/public/static/demo.gif" alt="Arena Agents Demo" width="800"/>
</p>
...
The easiest way to run Arena Agents locally is using our [NPM package](https://www.npmjs.com/package/simstudio?activeTab=readme):
=======
...
<<<<<<< HEAD
- `-p, --port <port>`: Specify the port to run Arena Agents on (default: 3000)
