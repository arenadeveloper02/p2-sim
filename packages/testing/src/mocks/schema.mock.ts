...
export const schemaMock = {
  ...
  embedding: {
    ...
    embedding384: 'embedding.embedding384',
    embedding768: 'embedding.embedding768',
    embedding1024: 'embedding.embedding1024',
    embedding3072: 'embedding.embedding3072',
  ...
  copilotChats: {
    ...
    externalConversationKey: 'copilotChats.externalConversationKey',
    externalConversationMetadata: 'copilotChats.externalConversationMetadata',
  ...
  oauthClient: {
    ...
    contacts: 'oauthClient.contacts',
    tos: 'oauthClient.tos',
    policy: 'oauthClient.policy',
    softwareId: 'oauthClient.softwareId',
    softwareVersion: 'oauthClient.softwareVersion',
    softwareStatement: 'oauthClient.softwareStatement',
  ...
  oauthTokenFamily: {
    ...
    createdAt: 'oauthTokenFamily.createdAt',
  ...
  scimConnection: {
    ...
    reconcileLockToken: 'scimConnection.reconcileLockToken',
    reconcileLeaseAt: 'scimConnection.reconcileLeaseAt',
    reconciledAt: 'scimConnection.reconciledAt',
    createdBy: 'scimConnection.createdBy',
    createdAt: 'scimConnection.createdAt',
    updatedAt: 'scimConnection.updatedAt',
  },
  scimCredential: {
    ...
    revokedBy: 'scimCredential.revokedBy',
    lastUsedAt: 'scimCredential.lastUsedAt',
    createdBy: 'scimCredential.createdBy',
  ...
  scimUser: {
    ...
    orderKey: 'scimUser.orderKey',
    createdAt: 'scimUser.createdAt',
    updatedAt: 'scimUser.updatedAt',
  },
  scimUserTombstone: {
    id: 'scimUserTombstone.id',
    connectionId: 'scimUserTombstone.connectionId',
    externalId: 'scimUserTombstone.externalId',
    userId: 'scimUserTombstone.userId',
    deletedAt: 'scimUserTombstone.deletedAt',
  },
  scimGroup: {
    id: 'scimGroup.id',
    connectionId: 'scimGroup.connectionId',
    externalId: 'scimGroup.externalId',
    displayName: 'scimGroup.displayName',
    displayNameKey: 'scimGroup.displayNameKey',
    orderKey: 'scimGroup.orderKey',
    createdAt: 'scimGroup.createdAt',
    updatedAt: 'scimGroup.updatedAt',
  },
  scimGroupMember: {
    id: 'scimGroupMember.id',
    groupId: 'scimGroupMember.groupId',
    scimUserId: 'scimGroupMember.scimUserId',
    createdAt: 'scimGroupMember.createdAt',
  },
  scimGroupMapping: {
    ...
    createdBy: 'scimGroupMapping.createdBy',
    createdAt: 'scimGroupMapping.createdAt',
  },
  scimProjectionGrant: {
    id: 'scimProjectionGrant.id',
    connectionId: 'scimProjectionGrant.connectionId',
    scimUserId: 'scimProjectionGrant.scimUserId',
  ...
  scimRequestLog: {
    ...
    connectionId: 'scimRequestLog.connectionId',
    credentialId: 'scimRequestLog.credentialId',
  ...
  slackApp: {
    id: 'slackApp.id',
    organizationId: 'slackApp.organizationId',
    kind: 'slackApp.kind',
    clientId: 'slackApp.clientId',
    encryptedClientSecret: 'slackApp.encryptedClientSecret',
    encryptedSigningSecret: 'slackApp.encryptedSigningSecret',
    capabilities: 'slackApp.capabilities',
    revision: 'slackApp.revision',
    createdAt: 'slackApp.createdAt',
    updatedAt: 'slackApp.updatedAt',
  },
  slackSearchTurn: {
    id: 'slackSearchTurn.id',
    ordinal: 'slackSearchTurn.ordinal',
    installationId: 'slackSearchTurn.installationId',
    conversationKey: 'slackSearchTurn.conversationKey',
    eventId: 'slackSearchTurn.eventId',
    payload: 'slackSearchTurn.payload',
    status: 'slackSearchTurn.status',
    leaseId: 'slackSearchTurn.leaseId',
    leaseExpiresAt: 'slackSearchTurn.leaseExpiresAt',
    outcome: 'slackSearchTurn.outcome',
    createdAt: 'slackSearchTurn.createdAt',
    updatedAt: 'slackSearchTurn.updatedAt',
  },
  slackSearchInstallation: {
    slackAppId: 'slackSearchInstallation.slackAppId',
    id: 'slackSearchInstallation.id',
    organizationId: 'slackSearchInstallation.organizationId',
    ...
    botUserId: 'slackSearchInstallation.botUserId',
    enterpriseId: 'slackSearchInstallation.enterpriseId',
    enabled: 'slackSearchInstallation.enabled',
    credentialVersion: 'slackSearchInstallation.credentialVersion',
    revision: 'slackSearchInstallation.revision',
    lastOutcome: 'slackSearchInstallation.lastOutcome',
    lastEventAt: 'slackSearchInstallation.lastEventAt',
    createdAt: 'slackSearchInstallation.createdAt',
    updatedAt: 'slackSearchInstallation.updatedAt',
  },
