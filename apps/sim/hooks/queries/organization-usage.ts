...
export const organizationUsageAnalyticsKeys = {
  all: ['organization-usage'] as const,
  analytics: () => [...organizationUsageAnalyticsKeys.all, 'analytics'] as const,
  analytic: (organizationId: string, query?: OrganizationUsageAnalyticsQuery) =>
    [...organizationUsageAnalyticsKeys.analytics(), organizationId, query ?? {}] as const,
}
...
export function useOrganizationUsageAnalytics(
  ...
  return useQuery({
    queryKey: organizationUsageAnalyticsKeys.analytic(organizationId ?? '', query),
    queryFn: ({ signal }) =>
