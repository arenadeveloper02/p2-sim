  ...
  subBlocks: [
    ...
    },
    {
      ...
      defaultValue: [
        ...
        'Optionally add a Webhook Secret for enhanced security - Arena will verify all incoming webhooks match this secret',
        'Arena will automatically register the webhook with Typeform when you deploy the workflow',
