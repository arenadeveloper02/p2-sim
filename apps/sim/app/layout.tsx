...
import { AppPublicEnvScript, publicEnvHtmlAttributes } from '@/app/_shell/public-env-script'
          ...
          dangerouslySetInnerHTML={{
            __html: `
              (function () {
                ...
                // 30% of the viewport, and never below the 238px minimum, so a
                // narrow window yields a width >= MIN instead of a sub-minimum sliver.
