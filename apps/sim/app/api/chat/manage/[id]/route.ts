...
import { listWorkflowGoldenQueryStrings } from '@/lib/chat-deployments/golden-queries'
...
export const GET = defineInternalJsonRoute({
  ...
  present: async ({ deployment }) =>
    toChatDetailResponse(
      deployment,
      buildChatDeploymentUrl(deployment.identifier),
      await listWorkflowGoldenQueryStrings(deployment.workflowId)
    ),
})
