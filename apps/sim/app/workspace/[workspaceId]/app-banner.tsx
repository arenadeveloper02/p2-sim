...
export function AppBanner() {
  const { data, isPending } = useAppBanner()
  ...
  return (
    <Banner
      ...
      className={cn(
        ...
        'bg-[var(--surface-3)] py-3',
        'shadow-[inset_0_1px_0_0_var(--divider)]'
      )}
    >
      <div className='mx-auto flex max-w-[1400px] items-start justify-center gap-2.5 px-6 sm:items-center'>
        <Info
        ...
        />
        <p
          className='max-w-[min(100%,42rem)] text-left text-[13px] leading-relaxed text-[var(--text-body)]'
        >
          {message}
        </p>
      </div>
