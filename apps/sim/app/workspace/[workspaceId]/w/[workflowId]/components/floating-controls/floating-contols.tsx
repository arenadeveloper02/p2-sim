...
export function FloatingControls() {
  ...
  return (
    <div className='-translate-x-1/2 fixed bottom-4 left-[380px] z-10'>
      <div className='flex items-center gap-1 rounded-[14px] border bg-card/95 px-1 py-0.5 shadow-lg backdrop-blur-sm'>
        <Tooltip>
