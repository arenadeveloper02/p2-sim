...
export function DeployModal({
  ...
  const isExistingChatDeployment = Boolean(existingChat && existingChat.deploymentType !== 'app')
  const isExistingAppDeployment = Boolean(existingChat && existingChat.deploymentType === 'app')
  ...
  const chatActionLabel = chatSuccess
    ...
    : chatSubmitting
      ...
      : isExistingChatDeployment
        ? 'Update'
        : 'Launch Chat'
  const appActionLabel = appSuccess
      ...
      >
        ...
        <ChipModalBody>
          ...
          <ChipModalTabs
            ...
            value={activeTab}
            onChange={(value) => {
              if (!isDeployModalTab(value)) return
              workflowDeployTabSwitchEvent({
