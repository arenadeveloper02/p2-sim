...
export const getDisplayValue = (value: unknown): string => {
  ...
  if (isPlainObject(parsedValue)) {
    if (parsedValue.customDisplayValue) {
      return parsedValue.customDisplayValue as string
    }
  ...
  return (
    <div className='flex items-center gap-[8px]'>
      ...
      {displayValue !== undefined && (
        <span
          className={cn(
            'flex-1 truncate text-right text-[14px] text-[var(--text-primary)] dark:text-[var(--white)]',
