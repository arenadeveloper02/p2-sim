  ...
  const markdownComponents = useMemo(
    () => ({
      ...
      p: ({ children }: React.HTMLAttributes<HTMLParagraphElement>) => (
        <p className='font-geist-sans my-2 text-base text-gray-800 leading-relaxed last:mb-0 dark:text-gray-200'>
          {children}
        </p>
      ),
      ...
      h1: ({ children }: React.HTMLAttributes<HTMLHeadingElement>) => (
        <h1 className='font-geist-sans my-3 font-semibold text-2xl text-gray-900 dark:text-gray-100'>
          {children}
        </h1>
      ),
      h2: ({ children }: React.HTMLAttributes<HTMLHeadingElement>) => (
        <h2 className='font-geist-sans my-3 font-semibold text-gray-900 text-xl dark:text-gray-100'>
          {children}
        </h2>
      ),
      h3: ({ children }: React.HTMLAttributes<HTMLHeadingElement>) => (
        <h3 className='font-geist-sans my-3 font-semibold text-gray-900 text-lg dark:text-gray-100'>
          {children}
        </h3>
      ),
      h4: ({ children }: React.HTMLAttributes<HTMLHeadingElement>) => (
        <h4 className='font-geist-sans my-3 font-semibold text-base text-gray-900 dark:text-gray-100'>
          {children}
        </h4>
      ),
