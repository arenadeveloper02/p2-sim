...
const TOP_LEVEL_REDIRECTS: Readonly<Record<string, (workspaceId: string) => string>> = {
  // Integrations still has a dedicated page under settings/integrations — this
  // only catches stale /settings/[section] bookmarks that resolve through the
  // dynamic segment instead of that route.
