...
export const HOME_PAGE_DESCRIPTION =
  'Arena is the open-source AI workspace where teams build, deploy, and manage AI agents across 1,000+ integrations and every major LLM, visually or with code.'
 ...
 */
export const HOME_PAGE_TITLE = 'Arena, The AI Workspace | Build, Deploy & Manage AI Agents'
