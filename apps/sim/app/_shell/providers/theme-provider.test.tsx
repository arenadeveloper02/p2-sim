...
describe('ThemeProvider theme stores', () => {
  ...
  it('keeps landing light even if a leftover landing-theme key is dark', () => {
    localStorage.setItem('sim-theme', 'system')
    localStorage.setItem('sim-landing-theme', 'dark')
    expect(render('/workflows')).toContain('light')
  })
  ...
  it('does not apply account settings to forced-light landing pages', () => {
