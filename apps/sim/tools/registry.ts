...
import {
  ...
  googleSlidesReplaceListsTool,
  googleSlidesReplaceTextTool,
...
import {
  ...
  servicenowDownloadAttachmentV2Tool,
...
import {
  ...
  shopifyNetSalesOverTimeTool,
  shopifyNewCustomerSalesOverTimeTool,
  shopifyNewCustomersOverTimeTool,
  shopifyNewVsReturningCustomersTool,
  shopifyOneTimeCustomersTool,
  shopifyOrdersOverTimeTool,
  shopifyPredictedSpendTiersTool,
  shopifyProductsOverTimeTool,
  shopifyRevenueByCustomerTool,
  shopifyRevenueByLocationTool,
  shopifyRevenueByProductTool,
  shopifyTopCustomersTool,
  shopifyTopSellingProductsTool,
...
import {
  unipileCommentPostTool,
  unipileCreatePostTool,
  unipileGetChatTool,
  unipileGetLinkedinSearchParametersTool,
  unipileGetMessageAttachmentTool,
  unipileGetPostTool,
  unipileGetUserProfileTool,
  unipileLinkedinSearchTool,
  unipileListAllChatsTool,
  unipileListChatAttendeesTool,
  unipileListChatMessagesTool,
  unipileListPostCommentsTool,
  unipileListPostReactionsTool,
  unipileListUserCommentsTool,
  unipileListUserPostsTool,
  unipileListUserReactionsTool,
  unipileListUserRelationsTool,
  unipileRetrieveCompanyDetailsTool,
  unipileSendChatMessageTool,
  unipileStartNewChatTool,
} from '@/tools/unipile'
import {
...
export const tools: Record<string, ExecutableToolConfig> = {
  ...
  arena_fetch_searched_tasks: arenaFetchSearchedTasks,
  ...
  box_download_file_v2: boxDownloadFileV2Tool,
  ...
  sftp_download_v2: sftpDownloadV2Tool,
  ...
  ssh_download_file_v2: sshDownloadFileV2Tool,
  ...
  jupyter_get_content_v2: jupyterGetContentV2Tool,
  ...
  slack_get_auth_user: slackGetAuthUserTool,
  slack_get_user_channels: slackGetUserChannelsTool,
  ...
  servicenow_download_attachment_v2: servicenowDownloadAttachmentV2Tool,
  ...
  gmail_read_thread: gmailReadThreadTool,
  gmail_read_thread_v2: gmailReadThreadV2Tool,
  ...
  coda_add_custom_domain: codaAddCustomDomainTool,
  coda_add_permission: codaAddPermissionTool,
  coda_change_user_role: codaChangeUserRoleTool,
  coda_create_doc: codaCreateDocTool,
  coda_create_folder: codaCreateFolderTool,
  coda_create_page: codaCreatePageTool,
  coda_delete_custom_domain: codaDeleteCustomDomainTool,
  coda_delete_doc: codaDeleteDocTool,
  coda_delete_folder: codaDeleteFolderTool,
  coda_delete_page: codaDeletePageTool,
  coda_delete_page_content: codaDeletePageContentTool,
  coda_delete_permission: codaDeletePermissionTool,
  coda_delete_row: codaDeleteRowTool,
  coda_delete_rows: codaDeleteRowsTool,
  coda_export_page: codaExportPageTool,
  coda_get_acl_settings: codaGetAclSettingsTool,
  coda_get_analytics_last_updated: codaGetAnalyticsLastUpdatedTool,
  coda_get_column: codaGetColumnTool,
  coda_get_control: codaGetControlTool,
  coda_get_custom_domain_provider: codaGetCustomDomainProviderTool,
  coda_get_doc: codaGetDocTool,
  coda_get_doc_analytics_summary: codaGetDocAnalyticsSummaryTool,
  coda_get_folder: codaGetFolderTool,
  coda_get_formula: codaGetFormulaTool,
  coda_get_mutation_status: codaGetMutationStatusTool,
  coda_get_page: codaGetPageTool,
  coda_get_page_content: codaGetPageContentTool,
  coda_get_page_export_status: codaGetPageExportStatusTool,
  coda_get_row: codaGetRowTool,
  coda_get_sharing_metadata: codaGetSharingMetadataTool,
  coda_get_table: codaGetTableTool,
  coda_list_categories: codaListCategoriesTool,
  coda_list_columns: codaListColumnsTool,
  coda_list_controls: codaListControlsTool,
  coda_list_custom_domains: codaListCustomDomainsTool,
  coda_list_doc_analytics: codaListDocAnalyticsTool,
  coda_list_docs: codaListDocsTool,
  coda_list_folder_children: codaListFolderChildrenTool,
  coda_list_folders: codaListFoldersTool,
  coda_list_formulas: codaListFormulasTool,
  coda_list_page_analytics: codaListPageAnalyticsTool,
  coda_list_pages: codaListPagesTool,
  coda_list_permissions: codaListPermissionsTool,
  coda_list_rows: codaListRowsTool,
  coda_list_tables: codaListTablesTool,
  coda_list_workspace_members: codaListWorkspaceMembersTool,
  coda_list_workspace_roles: codaListWorkspaceRolesTool,
  coda_publish_doc: codaPublishDocTool,
  coda_push_button: codaPushButtonTool,
  coda_resolve_browser_link: codaResolveBrowserLinkTool,
  coda_search_principals: codaSearchPrincipalsTool,
  coda_trigger_automation: codaTriggerAutomationTool,
  coda_unpublish_doc: codaUnpublishDocTool,
  coda_update_acl_settings: codaUpdateAclSettingsTool,
  coda_update_doc: codaUpdateDocTool,
  coda_update_folder: codaUpdateFolderTool,
  coda_update_page: codaUpdatePageTool,
  coda_update_row: codaUpdateRowTool,
  coda_upsert_rows: codaUpsertRowsTool,
  coda_whoami: codaWhoamiTool,
  ...
  dropbox_download_v2: dropboxDownloadV2Tool,
  ...
  dub_get_qr_code_v2: dubGetQrCodeV2Tool,
  ...
  google_slides_create_from_template: googleSlidesCreateFromTemplateTool,
  google_slides_duplicate: googleSlidesDuplicateTool,
  google_slides_replace_all_text: googleSlidesReplaceAllTextTool,
  google_slides_replace_text: googleSlidesReplaceTextTool,
  google_slides_replace_lists: googleSlidesReplaceListsTool,
  ...
  quiver_image_to_svg_v2: quiverImageToSvgV2Tool,
  quiver_list_models: quiverListModelsTool,
  quiver_text_to_svg: quiverTextToSvgTool,
  quiver_text_to_svg_v2: quiverTextToSvgV2Tool,
  ...
  shopify_gross_sales_over_time: shopifyGrossSalesOverTimeTool,
  shopify_net_sales_over_time: shopifyNetSalesOverTimeTool,
  shopify_orders_over_time: shopifyOrdersOverTimeTool,
  shopify_customers_over_time: shopifyCustomersOverTimeTool,
  shopify_products_over_time: shopifyProductsOverTimeTool,
  shopify_revenue_by_product: shopifyRevenueByProductTool,
  shopify_revenue_by_customer: shopifyRevenueByCustomerTool,
  shopify_revenue_by_location: shopifyRevenueByLocationTool,
  shopify_top_selling_products: shopifyTopSellingProductsTool,
  shopify_top_customers: shopifyTopCustomersTool,
  shopify_new_customer_sales_over_time: shopifyNewCustomerSalesOverTimeTool,
  shopify_new_customers_over_time: shopifyNewCustomersOverTimeTool,
  shopify_new_vs_returning_customers: shopifyNewVsReturningCustomersTool,
  shopify_one_time_customers: shopifyOneTimeCustomersTool,
  shopify_predicted_spend_tiers: shopifyPredictedSpendTiersTool,
  ...
  microsoft_dataverse_download_file_v2: dataverseDownloadFileV2Tool,
  ...
  hubspot_get_commerce_payment: hubspotGetCommercePaymentTool,
  hubspot_get_import: hubspotGetImportTool,
  hubspot_get_object: hubspotGetObjectTool,
  hubspot_get_pipeline: hubspotGetPipelineTool,
  hubspot_get_property: hubspotGetPropertyTool,
  hubspot_get_subscription: hubspotGetSubscriptionTool,
  hubspot_list_association_types: hubspotListAssociationTypesTool,
  hubspot_list_campaigns: hubspotListCampaignsTool,
  hubspot_list_commerce_payments: hubspotListCommercePaymentsTool,
  hubspot_list_imports: hubspotListImportsTool,
  hubspot_list_objects: hubspotListObjectsTool,
  hubspot_list_pipelines: hubspotListPipelinesTool,
  hubspot_list_properties: hubspotListPropertiesTool,
  hubspot_list_subscriptions: hubspotListSubscriptionsTool,
  hubspot_get_campaign: hubspotGetCampaignTool,
  hubspot_get_campaign_spend: hubspotGetCampaignSpendTool,
  hubspot_get_campaign_metrics: hubspotGetCampaignMetricsTool,
  hubspot_get_campaign_revenue: hubspotGetCampaignRevenueTool,
  hubspot_get_campaign_contacts: hubspotGetCampaignContactsTool,
  ...
  unipile_comment_post: unipileCommentPostTool,
  unipile_create_post: unipileCreatePostTool,
  unipile_get_chat: unipileGetChatTool,
  unipile_get_message_attachment: unipileGetMessageAttachmentTool,
  unipile_get_linkedin_search_parameters: unipileGetLinkedinSearchParametersTool,
  unipile_get_post: unipileGetPostTool,
  unipile_get_user_profile: unipileGetUserProfileTool,
  unipile_linkedin_search: unipileLinkedinSearchTool,
  unipile_list_all_chats: unipileListAllChatsTool,
  unipile_list_chat_attendees: unipileListChatAttendeesTool,
  unipile_list_chat_messages: unipileListChatMessagesTool,
  unipile_list_post_comments: unipileListPostCommentsTool,
  unipile_list_post_reactions: unipileListPostReactionsTool,
  unipile_list_user_comments: unipileListUserCommentsTool,
  unipile_list_user_posts: unipileListUserPostsTool,
  unipile_list_user_reactions: unipileListUserReactionsTool,
  unipile_list_user_relations: unipileListUserRelationsTool,
  unipile_retrieve_company_details: unipileRetrieveCompanyDetailsTool,
  unipile_send_chat_message: unipileSendChatMessageTool,
  unipile_start_new_chat: unipileStartNewChatTool,
