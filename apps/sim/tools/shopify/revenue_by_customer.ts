...
interface RevenueByCustomerParams extends ShopifyBaseParams {
  startDate?: string
  endDate?: string
  limit?: number
}
...
interface RevenueByCustomerResponse {
  success: boolean
  error?: string
  output: {
...
export const shopifyRevenueByCustomerTool: ToolConfig<RevenueByCustomerParams, RevenueByCustomerResponse> = {
  ...
  outputs: {
    customers: { type: 'json', description: 'Revenue data per customer' },
