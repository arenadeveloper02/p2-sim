...
export function arenaGenerativeToolRequestBody(
  ...
  return filterUndefined({
    ...
    lockPlan: omitNullish(params.lockPlan),
    planOnly: omitNullish(params.planOnly),
    planChanges: omitNullish(params.planChanges),
    composition: omitNullish(params.composition),
    iaPreset: omitNullish(params.iaPreset),
