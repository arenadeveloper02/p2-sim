  ...
  subBlocks: [
    {
      ...
      options: [
        ...
        { label: 'BlackFridayStreet.com', id: 'blackfridaystreet' },
        { label: 'BlackFriyay.com', id: 'blackfriyay' },
        { label: 'Botmetric', id: 'botmetric' },
        { label: 'BusinessBytes.net', id: 'businessbytes' },
      ],
      fetchOptions: async () => {
        try {
