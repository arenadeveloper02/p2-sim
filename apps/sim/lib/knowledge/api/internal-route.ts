...
export async function resolveInternalKnowledgeBillingAttribution(
  ...
  /**
   * Attribute indexing to the knowledge base workspace, not an INTERNAL_JWT billing
   * header from the caller workspace. Workflows can write into a KB outside their
   * own workspace; requiring a matching header left uploads stuck at `pending`.
   */
