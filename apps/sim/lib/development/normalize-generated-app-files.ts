...
/** Latest stable releases aligned with the Sim monorepo (Next 15.3 + React 19). Exact pins — no ^/~. 15.3.6 patches the CVE Vercel flags as "Vulnerable version of Next.js". */
export const PINNED_NEXT_VERSION = '15.3.6'
export const PINNED_REACT_VERSION = '19.2.1'
...
- NEVER write "^${PINNED_NEXT_VERSION}", "~${PINNED_REACT_VERSION}", or any other range — every dependency version must be an exact semver (e.g. "${PINNED_NEXT_VERSION}")
