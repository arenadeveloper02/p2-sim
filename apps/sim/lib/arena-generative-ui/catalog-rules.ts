...
export const ARENA_GENERATIVE_UI_COMPONENT_RULES = [
  ...
  'Chrome: start a page with PageHeader (kicker, title, subtitle, optional trailing child) instead of a bare Heading. Filter children are Select, TextInput, DateInput, or Chip named after collection columns — the host filters locally when those fields have no actionId. Modal and Drawer use showWhen; close with a ghost Button clearItem true.',
