...
const agentResultsSpec: Spec = {
  ...
  elements: {
    ...
    result_actions: {
      ...
      children: ['copy_markdown', 'download_pdf'],
    },
    copy_markdown: {
      type: 'Button',
      props: {
...
const agentHistorySpec: Spec = {
  ...
  elements: {
    ...
    history_actions: {
      ...
      children: ['history_copy_markdown', 'history_download_pdf'],
    },
    history_copy_markdown: {
      type: 'Button',
      props: {
        label: 'Copy Markdown',
        actionId: null,
    ...
    history_views: {
      ...
      children: ['history_view_enhanced', 'history_view_coverage'],
    },
    history_view_enhanced: {
      type: 'Chip',
      props: {
        text: 'Enhanced Article',
        tone: 'muted',
    ...
    history_enhanced: {
      ...
      children: ['history_enhanced_body'],
    },
    history_enhanced_body: {
      type: 'DataText',
      props: {
        statePath: 'content',
        fallback: 'Open a run to view its article.',
        color: null,
        size: null,
      },
      children: [],
    ...
    history_coverage: {
      ...
      children: ['history_coverage_body'],
    },
    history_coverage_body: {
      type: 'DataText',
      props: {
        statePath: 'coverage_report',
        fallback: 'Coverage appears after Open.',
        color: null,
        size: null,
      },
      children: [],
...
export const ARENA_GENERATIVE_UI_GOLD_EXAMPLE_AGENT_SHELL = goldPrompt(
  'agent-shell',
  [
    'Agent product shell when shell.tabs with task + results (History collection only when pages[] listed it).',
    'Three paths: home (Generator form), results (navigate destination from generate), history (collection).',
  ...
  {
    title: 'Article agent',
    content: 'Generator form, results with Chip views, and same-page History Open.',
