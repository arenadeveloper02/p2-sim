...
export const LLM_KEY_POOLS = {
  ...
  xai: {
    keys: ['XAI_API_KEY_1', 'XAI_API_KEY_2', 'XAI_API_KEY_3'],
    fallbackKey: 'XAI_API_KEY',
  },
  ...
  sambanova: {
    keys: ['SAMBANOVA_API_KEY_1', 'SAMBANOVA_API_KEY_2', 'SAMBANOVA_API_KEY_3'],
    fallbackKey: 'SAMBANOVA_API_KEY',
  },
} as const
