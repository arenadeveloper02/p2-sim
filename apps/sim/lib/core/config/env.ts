...
export const env = createEnv({
  ...
  server: {
    ...
    IDEOGRAM_API_KEY:                      z.string().min(1).optional(),           // Ideogram API key for Image Generator (used when block omits BYOK key)
    ...
    DEVELOPMENT_ANTHROPIC_MODEL:             z.string().min(1).optional(),           // Optional override for creation model (default in code: claude-fable-5)
    DEVELOPMENT_ANTHROPIC_CREATION_MODEL:    z.string().min(1).optional(),           // Optional override for new app generation (default in code: claude-fable-5)
    DEVELOPMENT_ANTHROPIC_EDIT_MODEL:        z.string().min(1).optional(),           // Optional override for app edits/repair (default in code: claude-opus-4-8)
    ...
    EXECUTION_TIMEOUT_FREE:                z.string().optional().default('60000'),   // 5 minutes
    EXECUTION_TIMEOUT_PRO:                 z.string().optional().default('60000'),  // 50 minutes
    EXECUTION_TIMEOUT_TEAM:                z.string().optional().default('60000'),  // 50 minutes
    EXECUTION_TIMEOUT_ENTERPRISE:          z.string().optional().default('60000'),  // 50 minutes
    EXECUTION_TIMEOUT_ASYNC_FREE:          z.string().optional().default('60000'),  // 90 minutes
    EXECUTION_TIMEOUT_ASYNC_PRO:           z.string().optional().default('60000'),  // 90 minutes
    EXECUTION_TIMEOUT_ASYNC_TEAM:          z.string().optional().default('60000'),  // 90 minutes
    EXECUTION_TIMEOUT_ASYNC_ENTERPRISE:    z.string().optional().default('60000'),  // 90 minutes
