...
export const RECONCILE_PRICED_TOOL_ALLOWLIST = [
  ...
  'google_nano_banana',
  'video_falai',
  'ideogram_generate_v4',
  'ideogram_generate_v4_async',
  'ideogram_remix_v4',
  'ideogram_generate_v3',
  'ideogram_generate_transparent_v3',
  'ideogram_inpaint_v3',
  'ideogram_remix_v3',
  'ideogram_reframe_v3',
  'ideogram_replace_background_v3',
  'ideogram_edit',
  'ideogram_upscale',
  'ideogram_describe',
  'ideogram_describe_v4',
  'ideogram_layerize_text',
